		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Documento CAD",
									"targetURL": "#goscmdocumentocad-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"goscmdocumentocad-display": {
								"semanticObject": "goscmdocumentocad",
								"action": "display",
								"description": "Documento CAD",
								"title": "Documento CAD",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=goscm.documentocad",
									"url": sap.ui.require.toUrl("goscm/documentocad")
								}
							}
						}
					}
